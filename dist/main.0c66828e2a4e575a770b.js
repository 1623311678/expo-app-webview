...
var arrayMethodIsStrict = __webpack_require__(275);
...
var PROPER_FUNCTION_NAME = __webpack_require__(86).PROPER;
var defineBuiltIn = __webpack_require__(34);
var anObject = __webpack_require__(35);
var $toString = __webpack_require__(42);
var fails = __webpack_require__(11);
var getRegExpFlags = __webpack_require__(254);
...
var $ = __webpack_require__(19);
var DESCRIPTORS = __webpack_require__(23);
var defineProperties = __webpack_require__(93).f;
...
var es_object_get_own_property_descriptor = __webpack_require__(273);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.for-each.js
var es_array_for_each = __webpack_require__(274);

// EXTERNAL MODULE: ./node_modules/core-js/modules/web.dom-collections.for-each.js
var web_dom_collections_for_each = __webpack_require__(276);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.get-own-property-descriptors.js
var es_object_get_own_property_descriptors = __webpack_require__(277);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.define-properties.js
var es_object_define_properties = __webpack_require__(278);
...
function events_attachEvents() {
  ...
  swiper.onLoad = onLoad_onLoad.bind(swiper);
...
function events_detachEvents() {
  const swiper = this;
  events_events(swiper, 'off');
}
/* harmony default export */ var core_events = ({
  attachEvents: events_attachEvents,
  detachEvents: events_detachEvents
});
...
function components_shared_utils_isObject(o) {
  return typeof o === 'object' && o !== null && o.constructor && Object.prototype.toString.call(o).slice(8, -1) === 'Object';
}
function components_shared_utils_extend(target, src) {
  const noExtend = ['__proto__', 'constructor', 'prototype'];
  Object.keys(src).filter(key => noExtend.indexOf(key) < 0).forEach(key => {
    if (typeof target[key] === 'undefined') target[key] = src[key];else if (components_shared_utils_isObject(src[key]) && components_shared_utils_isObject(target[key]) && Object.keys(src[key]).length > 0) {
      if (src[key].__swiper__) target[key] = src[key];else components_shared_utils_extend(target[key], src[key]);
    } else {
      target[key] = src[key];
    }
  });
...
function getParams(obj = {}, splitEvents = true) {
  ...
  const events = {};
  const passedParams = {};
  components_shared_utils_extend(params, core.defaults);
  components_shared_utils_extend(params, core.extendedDefaults);
  ...
  Object.keys(plainObj).forEach(key => {
    ...
    if (allowedParams.indexOf(key) >= 0) {
      if (components_shared_utils_isObject(obj[key])) {
        params[key] = {};
        passedParams[key] = {};
        components_shared_utils_extend(params[key], obj[key]);
        components_shared_utils_extend(passedParams[key], obj[key]);
      } else {
        params[key] = obj[key];
...
function getChangedParams(swiperParams, oldParams, children, oldChildren, getKey) {
  ...
  watchParams.forEach(key => {
    if (key in swiperParams && key in oldParams) {
      if (components_shared_utils_isObject(swiperParams[key]) && components_shared_utils_isObject(oldParams[key])) {
...
function processChildren(c) {
  const slides = [];
  react_default.a.Children.toArray(c).forEach(child => {
...
function updateSwiper({
  ...
  updateParams.forEach(key => {
    if (components_shared_utils_isObject(currentParams[key]) && components_shared_utils_isObject(passedParams[key])) {
      components_shared_utils_extend(currentParams[key], passedParams[key]);
...
function useIsomorphicLayoutEffect(callback, deps) {
  // eslint-disable-next-line
  if (typeof window === 'undefined') return Object(react["useEffect"])(callback, deps);
  return Object(react["useLayoutEffect"])(callback, deps);
}

// CONCATENATED MODULE: ./node_modules/swiper/react/context.js

const SwiperSlideContext = /*#__PURE__*/Object(react["createContext"])(null);
const useSwiperSlide = () => {
  return Object(react["useContext"])(SwiperSlideContext);
};
const SwiperContext = /*#__PURE__*/Object(react["createContext"])(null);
const useSwiper = () => {
  return Object(react["useContext"])(SwiperContext);
};
...
const swiper_Swiper = /*#__PURE__*/Object(react["forwardRef"])(function (_temp, externalElRef) {
  let {
    className,
    tag: Tag = 'div',
  ...
  const [containerClasses, setContainerClasses] = Object(react["useState"])('swiper');
  const [virtualData, setVirtualData] = Object(react["useState"])(null);
  const [breakpointChanged, setBreakpointChanged] = Object(react["useState"])(false);
  const initializedRef = Object(react["useRef"])(false);
  const swiperElRef = Object(react["useRef"])(null);
  const swiperRef = Object(react["useRef"])(null);
  const oldPassedParamsRef = Object(react["useRef"])(null);
  const oldSlides = Object(react["useRef"])(null);
  const nextElRef = Object(react["useRef"])(null);
  const prevElRef = Object(react["useRef"])(null);
  const paginationElRef = Object(react["useRef"])(null);
  const scrollbarElRef = Object(react["useRef"])(null);
  const {
    params: swiperParams,
    passedParams,
    rest: restProps,
  ...
  const initSwiper = () => {
    ...
    swiperRef.current = new core(passParams);
    if (swiperRef.current.virtual && swiperRef.current.params.virtual.enabled) {
      ...
      components_shared_utils_extend(swiperRef.current.params.virtual, extendWith);
      components_shared_utils_extend(swiperRef.current.originalParams.virtual, extendWith);
    }
  };
  ...
  return /*#__PURE__*/react_default.a.createElement(Tag, _extends({
    ref: swiperElRef,
    className: uniqueClasses(`${containerClasses}${className ? ` ${className}` : ''}`)
  }, restProps), /*#__PURE__*/react_default.a.createElement(SwiperContext.Provider, {
    value: swiperRef.current
  }, slots['container-start'], /*#__PURE__*/react_default.a.createElement(WrapperTag, {
    className: wrapperClass(swiperParams.wrapperClass)
  }, slots['wrapper-start'], renderSlides(), slots['wrapper-end']), needsNavigation(swiperParams) && /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("div", {
    ref: prevElRef,
    className: "swiper-button-prev"
  }), /*#__PURE__*/react_default.a.createElement("div", {
    ref: nextElRef,
    className: "swiper-button-next"
  })), needsScrollbar(swiperParams) && /*#__PURE__*/react_default.a.createElement("div", {
    ref: scrollbarElRef,
    className: "swiper-scrollbar"
  }), needsPagination(swiperParams) && /*#__PURE__*/react_default.a.createElement("div", {
    ref: paginationElRef,
...
const SwiperSlide = /*#__PURE__*/Object(react["forwardRef"])(function (_temp, externalRef) {
  let {
    tag: Tag = 'div',
    children,
    className = '',
  ...
  const slideElRef = Object(react["useRef"])(null);
  const [slideClasses, setSlideClasses] = Object(react["useState"])('swiper-slide');
  const [lazyLoaded, setLazyLoaded] = Object(react["useState"])(false);
  ...
  return /*#__PURE__*/react_default.a.createElement(Tag, swiper_slide_extends({
    ref: slideElRef,
    className: uniqueClasses(`${slideClasses}${className ? ` ${className}` : ''}`),
    "data-swiper-slide-index": virtualIndex,
    onLoad: onLoad
  }, rest), zoom && /*#__PURE__*/react_default.a.createElement(SwiperSlideContext.Provider, {
    value: slideData
  }, /*#__PURE__*/react_default.a.createElement("div", {
    className: "swiper-zoom-container",
    "data-swiper-zoom": typeof zoom === 'number' ? zoom : undefined
  }, renderChildren(), lazy && !lazyLoaded && /*#__PURE__*/react_default.a.createElement("div", {
    className: "swiper-lazy-preloader"
  }))), !zoom && /*#__PURE__*/react_default.a.createElement(SwiperSlideContext.Provider, {
    value: slideData
  }, renderChildren(), lazy && !lazyLoaded && /*#__PURE__*/react_default.a.createElement("div", {
    className: "swiper-lazy-preloader"
  })));
...
function Home() {
  ...
  }, /*#__PURE__*/react_default.a.createElement(swiper_Swiper, {
  ...
  }, /*#__PURE__*/react_default.a.createElement(SwiperSlide, {
    style: _objectSpread({
      background: "green"
    }, SwiperStyle)
  }, "Slide 1"), /*#__PURE__*/react_default.a.createElement(SwiperSlide, {
    style: _objectSpread({
      background: "blue"
    }, SwiperStyle)
  }, "Slide 2"), /*#__PURE__*/react_default.a.createElement(SwiperSlide, {
    style: _objectSpread({
      background: "yellow"
    }, SwiperStyle)
  }, "Slide 3"), /*#__PURE__*/react_default.a.createElement(SwiperSlide, {
    style: _objectSpread({
      background: "red"
    }, SwiperStyle)
  }, "Slide 4")), /*#__PURE__*/react_default.a.createElement("div", null, /*#__PURE__*/react_default.a.createElement(antd_mobile_es["d" /* Skeleton */].Title, {
    animated: true
  }), /*#__PURE__*/react_default.a.createElement(antd_mobile_es["d" /* Skeleton */].Paragraph, {
    lineCount: 5,
    animated: true
  })), /*#__PURE__*/react_default.a.createElement("div", null, /*#__PURE__*/react_default.a.createElement(antd_mobile_es["c" /* Rate */], {
    onChange: function onChange(val) {
      return antd_mobile_es["f" /* Toast */].show(val.toString());
    }
  })), /*#__PURE__*/react_default.a.createElement(antd_mobile_es["c" /* Rate */], {
    allowHalf: true,
    defaultValue: 2.5
  }), /*#__PURE__*/react_default.a.createElement(antd_mobile_es["b" /* NumberKeyboard */], {
    visible: true,
...
var app_App = function App() {
  ...
  // })
  return /*#__PURE__*/react_default.a.createElement(pages_Home, null);
};
